...
| GET     | `/api/flow/flow-projection-list` | —                                             | Alle entdeckten Projection-Handler, gemappt nach Flow-Typ: `{ projectionHandlerClass, projectionMessageMethods }` (Message-Source → Handler-Methode)                                  |
